  ...
  Properties newPropertiesWithMapValue(Object element) { Properties p = new Properties(); p.put(null, element); return p; }
	...
	public void test() throws Exception {
      ...
      in.add(List.of(source()).iterator());
		...
		{
      // "org.springframework.util;StringUtils;false;arrayToCommaDelimitedString;;;ArrayValue of Argument[0];ReturnValue;taint",
			String out = null;
			Object[] in = { source() };
		...
		{
      // "org.springframework.util;StringUtils;false;arrayToDelimitedString;;;ArrayValue of Argument[0];ReturnValue;taint",
			String out = null;
			Object[] in = { source() };
